...
from cerberus.predictors.standard import *

data = pd.read_csv('./exampleData/CaliforniaHousing.csv')

test0 = BasicMultStepVar(2, 10, data = data, features = ['target','HouseAge','AveRooms','AveBedrms','Population','AveOccup','Latitude','Longitude','MedInc'])
